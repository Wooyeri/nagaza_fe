...
export default function ListMovieCard({id, likeCount, title, posterUrl, cast, reserRate ,emotionRating, aiReview}){
    ...
    const containerStyles = { minWidth: '500px', maxWidth: '530px', minHeight: '400px', display: 'flex', padding: '15px 0', width: "fit-content", boxShadow:"0 4px 8px 0 rgba(0, 0, 0, 0.2)", borderRadius: "10px", textAlign: 'center', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' };
