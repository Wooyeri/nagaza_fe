...
import LikeList from "@/components/myList/LikeList";
...
export default function MyLikeSaved(){
    ...
    const buttonFont = { textAlign: 'center', fontSize: '16px', margin: '15px', color: darkMode ? darkPallete.plainText : lightPallete.plainText };
